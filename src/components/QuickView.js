        ...
        <div className="modal" ref="modal">
          ...
          <div className="quick-view">
            ...
            <div className="quick-view-details">
              <span className="product-name">{this.props.product.name} - {this.props.product.measurement} ({this.props.product.brand})</span>
							<span className="product-description"> {this.props.product.desc}</span>
